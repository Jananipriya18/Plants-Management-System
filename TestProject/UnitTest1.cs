...
public class ApplicationTests
{
    ...
    [Test, Order(6)]
    public async Task Backend_Test_Get_Plants_As_Admin()
    {
        string uniqueId = Guid.NewGuid().ToString();
        ...
        // Send GET request to retrieve plants
        _httpClient.DefaultRequestHeaders.Add("Authorization", "Bearer " + token);
        HttpResponseMessage plantsResponse = await _httpClient.GetAsync("/api/plants");

        Assert.AreEqual(HttpStatusCode.OK, plantsResponse.StatusCode);
    }

    [Test, Order(7)]
    public async Task Backend_Test_Get_Plants_As_Customer()
    {
        string uniqueId = Guid.NewGuid().ToString();
